...
def test_aggregate_normalizes_known_dimensions_and_manual_review_low_coverage() -> None:
    dimensions = [
        DimensionScore(dimension="skill_fit", weight=30, score=80, status=DimensionStatus.SUPPORTED, reason="ok", confidence=0.8),
        DimensionScore(dimension="responsibility_fit", weight=20, score=70, status=DimensionStatus.PARTIAL, reason="ok", confidence=0.6),
        DimensionScore(dimension="domain_fit", weight=50, score=None, status=DimensionStatus.UNKNOWN, reason="missing", confidence=0.1),
    ]
