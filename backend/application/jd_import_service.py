...
# Accepted image extensions -> canonical media types for sanitized uploads.
...
# Permissive MIME -> extension checks for the legacy single-image endpoint.
...
def _validate_image(filename: str, content_type: str | None, data: bytes) -> str:
    ...
    if content_type and content_type.lower() != expected_media_type:
